...
class Landing extends Component {
	...
	render(){
		return (
			<React.Fragment>
				<header className="header h-fullscreen" style={{backgroundImage: `url('/img/home.jpg')`}} data-overlay="2">
			        ...
			        <div className="container">
			          <div className="row align-items-center h-100">
			            <div className="col-lg-5">
			              ...
			              <div className="gap-xy"> <div className="btn btn-round btn-warning px-6">Buy Now</div></div>
			            </div>
			        ...
			        <div className="container">
			          <div className="row align-items-center h-100">
			            <div className="col-lg-6">
			              ...
			              <div className="gap-xy"> <div className="btn btn-round btn-primary">Buy Now</div></div>
			            </div>
			        ...
			        <div className="container">
			          <div className="row align-items-center h-100">
			            <div className="col-lg-6 align-self-center pb-lg-9">
			              ...
			              <div className="gap-xy"> <div className="btn btn-round btn-primary mw-150">Start Shopping</div></div>
			            </div>
